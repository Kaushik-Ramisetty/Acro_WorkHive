// Local drop-in replacement for the icons we use from lucide-react.
// Each icon mirrors lucide-react's API: <Icon size={n} color="..." style={...}/>.
// Paths are taken directly from the lucide.dev source so the SVG output matches.
...
function makeIcon(displayName, paths) {
  function Cmp({ size = 24, color = 'currentColor', style, className, strokeWidth = 2, ...rest }) {
    return (
      <svg
...
export const ChevronLeft  = makeIcon('ChevronLeft',  <polyline points="15 18 9 12 15 6" />);
export const ChevronRight = makeIcon('ChevronRight', <polyline points="9 18 15 12 9 6" />);
...
export const ChevronDown = makeIcon('ChevronDown', <polyline points="6 9 12 15 18 9" />);
export const ChevronUp   = makeIcon('ChevronUp',   <polyline points="18 15 12 9 6 15" />);
