...
export default function PayrollPage() {
  return (
    <UnderConstruction
      accent="amber"
      title="Payroll"
      description="Run pay cycles, manage salary structures, and handle statutory filings — all from a single Finance console."
      features={[
        ...
        { label: 'Payslip generation',       icon: _icoDoc      },
      ]}
    />
  );
}
